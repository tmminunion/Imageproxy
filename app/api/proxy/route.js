...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var searchParams, imageUrl, decodedUrl, response, contentType, base64String, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({ error: 'Fetch failed', details: error_1.message }, { status: 500 })];
